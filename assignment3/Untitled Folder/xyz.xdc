...
set_property PACKAGE_PIN R3 [get_ports {an1}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {an1}]
set_property PACKAGE_PIN W2 [get_ports {an2}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {an2}]
set_property PACKAGE_PIN U1 [get_ports {an3}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {an3}]
set_property PACKAGE_PIN T1 [get_ports {an4}]					
...
set_property PACKAGE_PIN U2 [get_ports {o1}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {o1}]
set_property PACKAGE_PIN U4 [get_ports {o2}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {o2}]
set_property PACKAGE_PIN V4 [get_ports {o3}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {o3}]
set_property PACKAGE_PIN W4 [get_ports {o4}]					
